...
************************************************************************************/
inline daughter_board_response_t button_up_int_enable(uint32_t priority);
...
* Output: daughter_board_response_t response_code
************************************************************************************/
daughter_board_response_t button_all_int_enable(uint32_t priority);
